...
const ServiceProviderServices = () => {
  ...
  const handleEditService = (serviceId) => {
    // Allow editing even with pending changes (will overwrite them)
  ...
  const handleDeleteService = (service) => {
    // Allow deletion even with pending changes (will overwrite them)
    if (service.pendingChanges) {
      const proceedWithDelete = window.confirm(
        'This service has pending changes awaiting approval. ' +
        'If you continue, your current pending changes will be replaced with a deletion request. ' +
        'Do you want to proceed?'
      );
      ...
      <Container component="main" sx={{ flexGrow: 1, py: 4 }}>
        ...
        {services.length === 0 ? (
          ...
          <TableContainer component={Paper} sx={{ 
            ...
            borderRadius: 3,
            boxShadow: '0 8px 25px rgba(13, 8, 109, 0.15)'
          }}>
            <Table>
              <TableHead sx={{ bgcolor: '#003047' }}>
                <TableRow>
                  ...
                  <TableCell><Typography fontWeight="bold" sx={{ color: 'white' }}>Target Audience</Typography></TableCell>
              ...
              <TableBody>
                {services.map((service) => (
                  ...
                  >
                    ...
                    <TableCell>{service.targetAudience}</TableCell>
                    <TableCell>
                      <IconButton
