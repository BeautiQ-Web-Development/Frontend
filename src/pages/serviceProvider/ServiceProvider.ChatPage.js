// pages/serviceProvider/ServiceProvider.ChatPage.js - Service Provider chat page
...
const ServiceProviderChatPage = () => {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <ServiceProviderSidebar open={navSidebarOpen} onClose={toggleSidebar} />
      <Box
        component="main"
        sx={{
          flexGrow: 1,
...
export default ServiceProviderChatPage;
