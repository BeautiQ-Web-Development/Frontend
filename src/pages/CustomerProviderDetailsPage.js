    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
        <Button 
          ...
          sx={{ mr: 2, borderColor: '#075B5E', color: '#075B5E' }}
        >
          ← Back
        </Button>
        <Typography variant="h4" component="h1" sx={{ color: '#075B5E', fontWeight: 'bold' }}>
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent sx={{ p: 4 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                ...
                />
                <Box>
                  <Typography variant="h5" sx={{ color: '#075B5E', fontWeight: 'bold' }}>
                    {provider.businessName}
                  </Typography>
              ...
              <Typography variant="h6" sx={{ color: '#075B5E', mb: 2 }}>
                About
              </Typography>
