// // admin/Admin.ServiceManagement.js - FIXED TO SHOW ALL SERVICE PROVIDER DETAILS
...
//       ? imagePath 
//       : `${process.env.REACT_APP_API_URL || 'http://localhost:5000'}/uploads/serviceProviders/${imagePath}`;
...
//                 <TableCell>
//                   <Chip 
//                     label={pkg?.availabilityStatus || 'Available'} 
//                     color={(pkg?.availabilityStatus || 'Available') === 'Available' ? 'success' : 'error'} 
//                     size="small" 
//                   />
//                 </TableCell>
...
//                     <ViewIcon />
//                   </IconButton>
//                   {(pkg.status === 'pending_approval' || pkg.pendingChanges) && (
//                     <>
//                       <IconButton 
//                         onClick={(e) => {
//                           e.stopPropagation();
...
//         {/* ENHANCED Details Dialog with ALL Registration Information */}
//         <Dialog 
...
//              detailsDialog.type === 'service' ? '🔧 Service Details' : '📦 Package Details'}
//           </DialogTitle>
...
//                 {/* Additional Services Information (if available) */}
//                 {detailsDialog.item.services && detailsDialog.item.services.length > 0 && (
//                   <Grid item xs={12}>
//                     <Card variant="outlined" sx={{ p: 3 }}>
...
//                       </Typography>
//                       <Grid container spacing={2}>
//                         {detailsDialog.item.services.map((service, index) => (
//                           <Grid item xs={12} sm={6} key={index}>
//                             <Card variant="outlined" sx={{ p: 2, backgroundColor: '#f8f9fa' }}>
//                               <Typography variant="subtitle2" sx={{ fontWeight: 600, color: '#003047' }}>
//                                 {service.name || `Service ${index + 1}`}
//                               </Typography>
//                               <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
//                                 Type: {service.type} | Category: {service.category}
//                               </Typography>
...
//                   <Typography variant="body1">{detailsDialog.item.packageType}</Typography>
//                 </Grid>
                
//                 <Grid item xs={12} sm={6}>
//                   <Typography variant="subtitle2" color="text.secondary">Target Audience</Typography>
//                   <Typography variant="body1">{detailsDialog.item.targetAudience}</Typography>
//                 </Grid>
                
//                 <Grid item xs={12} sm={6}>
//                   <Typography variant="subtitle2" color="text.secondary">Total Price</Typography>
//                   <Typography variant="body1">LKR {detailsDialog.item.totalPrice || 0}</Typography>
//                 </Grid>
                
//                 <Grid item xs={12} sm={6}>
//                   <Typography variant="subtitle2" color="text.secondary">Total Duration</Typography>
//                   <Typography variant="body1">{detailsDialog.item.totalDuration} minutes</Typography>
//                 </Grid>
                
//                 <Grid item xs={12}>
//                   <Typography variant="subtitle2" color="text.secondary">Description</Typography>
//                   <Typography variant="body1">{detailsDialog.item.packageDescription}</Typography>
//                 </Grid>
